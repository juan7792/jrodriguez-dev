  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/80 backdrop-blur transition-colors duration-200 dark:border-slate-800 dark:bg-slate-950/70">
      <nav className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
        ...
        {/* Controls: Theme, Language, Mobile Toggle */}
        <div className="flex items-center gap-3">
          {/* Theme Toggle */}
          <button
            type="button"
            className="inline-flex h-9 w-9 sm:h-10 sm:w-10 cursor-pointer items-center justify-center rounded-md border border-slate-200 bg-white text-sm hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800"
          ...
          {/* Language */}
          <select
            className="h-9 sm:h-10 cursor-pointer rounded-md border border-slate-200 bg-white px-3 text-sm hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800"
            value={locale}
      ...
      {/* Mobile Menu Panel */}
      {mobileOpen && (
        <div className="sm:hidden border-t border-slate-200 bg-white/90 backdrop-blur dark:border-slate-800 dark:bg-slate-950/85">
